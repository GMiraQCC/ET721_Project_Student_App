...
Within the file, each of the routes has a convenient, short description in the form of a comment. But to shortly reiterate:
...
At this point, there is a route & a function associated with (1) logging out & (2) signing up.
The last lines of code in this file allow the app to run.
